    ...
    return (
        <section className="relative font-sans">
            <div className="hero w-full h-[90vh]">
                ...
                <div className="flex flex-col gap-5 justify-center h-full items-center pt-12 px-6  lg:px-0 lg:mt-0">
                <h1 className="text-white lg:text-[42px] font-bold text-4xl text-center">Welcome to Swine And Dine Ranch</h1>
